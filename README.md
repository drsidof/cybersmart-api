# cybersmart-api
Cybersmart uses artificial intelligence and big data to identify fraudulent transactions. Our algorithm was built with scikit-learn, pandas and numpy hosted on a python flask interface. This solution was developed during First Bank Innovate Hackathon.

## Procedure
Our core producut is an API built on our cloud infrastructure on dedicated Virtual Private Servers.
In order to set up a microservice exposing a fraud detection POST endpoint, follow these steps:

1. get the code from the repository
```
git clone https://github.com/drsidof/cybersmart-api.git
```
